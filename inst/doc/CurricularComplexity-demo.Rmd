...
In fact, for prerequisite chains with no gaps in terms, this factor can be calculated using the delay factor, *when ignoring corequisite relationships* (denoted by $d'(c_i)$) like so:
